...
m1 <- lme4::glmer(fairness ~ incomeShare_W* incomeShare_NW + (1 | X), cd, family = binomial(link = "logit"))
summary(m1)

m2 <- lme4::glmer(team_work ~ incomeShare_W* incomeShare_NW + (1 | X), cd, family = binomial(link = "logit"))
summary(m2)

m3 <- lme4::glmer(work_in_team ~ incomeShare_W* incomeShare_NW + (1 | X), cd, family = binomial(link = "logit"))
summary(m3)

m4 <- lme4::glmer(distrust ~ incomeShare_W* incomeShare_NW + (1 | X), cd, family = binomial(link = "logit"))
summary(m4)
